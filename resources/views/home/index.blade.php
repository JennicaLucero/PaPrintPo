  ...
  <div class="partners-section">
    ...
    <div class="partners-container">
        ...
        <div class="partner-card">
            <img src="" alt="Epson Logo" class="partner-logo">
        ...
        <!-- Partner 2 -->
        <div class="partner-card">
            <img src="" alt="Canon Logo" class="partner-logo">
            <div class="partner-info">
        ...
        <!-- Partner 3 -->
        <div class="partner-card">
            <img src="" alt="HP Logo" class="partner-logo">
            <div class="partner-info">
        ...
        <!-- Partner 4 -->
        <div class="partner-card">
            <img src="" alt="Brother Logo" class="partner-logo">
            <div class="partner-info">
